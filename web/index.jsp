...
<html>
  ...
  <body>
    ...
    <p><b>/api/suggest?q={QUERY}[&c={COUNT}]</b> get suggestions for text address where QUERY - text request, COUNT (optional) - max returning objects (default 10). <i>Note: "geo_lat" "geo_lon" are set if c=1.</i></p>
