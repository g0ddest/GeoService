...
<html>
  ...
  <body>
    ...
    <p><b>/api/suggest?q={QUERY}[&c={COUNT}][&lat={LAT}&lon={LON}][&locations={LOC:street|city|area|province}&[locations_value={LOCV}]]</b> get suggestions for text address where QUERY - text request, COUNT (optional) - max returning objects (default 10).
